...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function handleButtonClick(button, confirmText) {
    button.addEventListener('click', (event) => {
      ...
      // Check if nameInput exists and has a valid value
  ...
  if (buttonSubmit) handleButtonClick(buttonSubmit, 'Are you sure you want to create this category?');
  if (buttonEdit) handleButtonClick(buttonEdit, 'Are you sure you want to update this category?');
